...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Animated mesh gradient background - gold/black */}
      <div 
        ...
        style={{
          background: `
            linear-gradient(
              135deg,
              hsl(48 96% 53% / 0.08) 0%,
              hsl(45 93% 47% / 0.06) 25%,
              hsl(0 0% 0% / 0.1) 50%,
              hsl(48 96% 53% / 0.06) 75%,
      ...
      {/* Soft ambient gold blobs */}
      <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] rounded-full blur-[120px] opacity-20 animate-blob-slow" 
        style={{ background: 'hsl(48 96% 53% / 0.3)' }} 
      />
      <div className="absolute bottom-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full blur-[120px] opacity-15 animate-blob-slow-reverse" 
        style={{ background: 'hsl(45 93% 47% / 0.25)' }} 
      />
      <div className="absolute top-[40%] left-[60%] w-[400px] h-[400px] rounded-full blur-[100px] opacity-10 animate-blob-slow-delay" 
        style={{ background: 'hsl(48 96% 53% / 0.2)' }} 
      />
