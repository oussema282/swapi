    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <button
          ...
          className="absolute top-6 right-4 z-[60] w-10 h-10 rounded-full bg-black/80 backdrop-blur-sm border-2 border-white/30 flex items-center justify-center hover:bg-black/90 transition-colors active:scale-95"
